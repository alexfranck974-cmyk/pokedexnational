...
const styles = StyleSheet.create({
  ...
  search: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: 12, fontSize: 15, backgroundColor: colors.surface },
  ...
  pokeballOverlay: { position: 'absolute', top: 4, left: 4, backgroundColor: 'rgba(255,255,255,0.9)', borderRadius: radius.pill, padding: 2 },
  heartBtn: {
